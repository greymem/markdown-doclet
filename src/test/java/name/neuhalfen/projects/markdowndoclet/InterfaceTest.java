...
import name.neuhalfen.projects.markdowndoclet.simpledata.Interface1;
import name.neuhalfen.projects.markdowndoclet.simpledata.Interface2;
import name.neuhalfen.projects.markdowndoclet.simpledata.Interface3;
import name.neuhalfen.projects.markdowndoclet.simpledata.Interface4;
import name.neuhalfen.projects.markdowndoclet.xmldoclet.xjc.AnnotationInstance;
import name.neuhalfen.projects.markdowndoclet.xmldoclet.xjc.Interface;
...
public class InterfaceTest extends AbstractTestParent {
	...
	public void testInterface1() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface1.java" };
	...
	public void testInterface2() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface2.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(method.getQualified(), "name.neuhalfen.projects.markdowndoclet.simpledata.Interface2.method1");
	...
	public void testInterface3() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testInterface4() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface4.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testInterface5() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface5.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "name.neuhalfen.projects.markdowndoclet.simpledata.Interface5");
		...
		assertFalse(method.isSynchronized());
		assertFalse(method.isVarArgs());
		assertEquals(method.getQualified(), "name.neuhalfen.projects.markdowndoclet.simpledata.Interface5.method1");
	...
	public void testInterface6() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface6.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "name.neuhalfen.projects.markdowndoclet.simpledata.Interface6");
		assertEquals(interfaceNode.getScope(), "public");
		assertEquals(interfaceNode.getMethod().size(), 0);
		assertEquals(interfaceNode.getAnnotation().size(), 0);
		assertEquals(interfaceNode.getInterface().size(), 0);
	...
	public void testInterface7() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface7.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "name.neuhalfen.projects.markdowndoclet.simpledata.Interface7");
		assertEquals(interfaceNode.getScope(), "public");
		assertEquals(interfaceNode.getMethod().size(), 0);
		assertEquals(interfaceNode.getAnnotation().size(), 0);
		assertEquals(interfaceNode.getInterface().size(), 0);
	...
	public void testInterface8() {
		String[] sourceFiles = new String[] { "./src/test/java/name/neuhalfen/projects/markdowndoclet/simpledata/Interface8.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "name.neuhalfen.projects.markdowndoclet.simpledata.Interface8");
		assertEquals(interfaceNode.getScope(), "public");
		assertEquals(interfaceNode.getMethod().size(), 0);
		assertEquals(interfaceNode.getAnnotation().size(), 0);
		assertEquals(interfaceNode.getInterface().size(), 0);
